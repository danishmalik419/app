...
exports.register = async (req, res) => {
  ...
  try {
    ...
    const verificationUrl = `https://app-4p89.onrender.com/api/auth/verify-email/${verificationToken}`;
...
exports.forgotPassword = async (req, res) => {
  ...
  try {
    ...
    const resetUrl = `https://app-bgnl-git-main-mohd-danishs-projects-26d774f1.vercel.app/reset-password/${resetToken}`;
